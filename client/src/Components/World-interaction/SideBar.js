            ...
            {props.world.characters.map((character) => {
              return character.userId === props.loggedInUserId ? (
                <Menu.Item
                  ...
                  onClick={(e) => {
                    setActiveItem(character.name);
                    setActiveContent(character);
                  }}
                >
                  <div>
      ...
      <Grid.Column stretched width={13}>
          ...
          {activeContent === props.world ? (
            <div>
              ...
              <Segment attached style={{ fontSize: "1em" }}>
                ...
                <br></br>
                <ReadMore>{activeContent.description}</ReadMore>{" "}
              </Segment>
            </div>
          ) : (
            <div>
              ...
              <div>
                <Segment attached style={{ fontSize: "1em" }}>
                  ...
                  <br></br>
                  <ReadMore>{activeContent.story} </ReadMore>
                </Segment>
              </div>
            </div>
          )}
        ...
        <div className="create-action">
          <Button.Group size="large">
            ...
            <Modal
              trigger={
                <Button onClick={() => setShowModalEvent(true)}>
                  {" "}
